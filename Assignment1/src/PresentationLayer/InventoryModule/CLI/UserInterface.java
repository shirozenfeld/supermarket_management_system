        ...
        while (choice != "8") {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    if (isInStore.size() > 1) {
                        System.out.println("NOTICE! item with catalog number " + itemID/10000 + " has reached it's minimum amount");
                ...
                case "6":
                    ...
                    while (more) {
                        ...
                        int cw = askInt("Please enter counted amount in warehouse");
                        if (imanage.setCountedAmount(cn,cs,cw))
                            System.out.println("Counted amount successfully updated");
                        else {
                            System.out.println("Item wasn't found, please try again");
                            continue;
                        }
